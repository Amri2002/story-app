...
export default function Index({auth, stories}: PageProps<{stories: 
    ...
    return (
        ...
        >
            <Head title="Stories" />   
                     {can(auth.user, 'manage_stories') && <div className='mb-8'>
                        <Link href={route('story.create')} className="inline-flex items-center rounded-md border border-transparent bg-gray-800 
                            ...
                            dark:text-gray-800 dark:hover:bg-white dark:focus:bg-white dark:focus:ring-offset-gray-800 dark:active:bg-gray-300">
